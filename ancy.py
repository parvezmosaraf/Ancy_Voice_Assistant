...
class Ancy:
    ...
    def wishMe(self) -> None:
        ...
        weather()
        speak('I am Ancy Ai. Please tell me how can I help you SIR?')
    ...
    def execute_query(self, query):
        ...
        if 'Ancy are you there' in query:
            speak("Yes Sir, at your service")
        if 'Ancy who made you' in query:
            speak("Yes Sir, my master Paul Zamor build me with AI")
            ...
            speak('My name is Ancy AI')
        elif 'who made you' in query:
            speak('I was created by Paul Zamor in 2023')
            
        elif 'stands for' in query:
            speak('Ancy AI stands for Personal Assistant Voice Command')
...
if __name__ == '__main__':
    ...
    names = ['','Paul']  #names, leave first empty bcz counter starts from 0
